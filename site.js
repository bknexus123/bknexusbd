...
function showCookieBanner() {
  ...
  document.body.insertAdjacentHTML('beforeend', `<aside class="cookie-banner" data-cookie-banner role="dialog" aria-modal="true" aria-labelledby="cookie-title"><div><h2 id="cookie-title">Privacy settings</h2><p>With your permission, we use optional analytics and marketing technologies. <a href="cookie-policy.html">Learn more</a> or change your choice anytime.</p></div><div class="cookie-actions"><button type="button" class="button secondary" data-cookie-reject>Reject optional</button><button type="button" class="button" data-cookie-accept>Accept optional</button></div></aside>`);
